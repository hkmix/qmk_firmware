...
[_TL] = KEYMAP_HHKB(
  ...
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, \
  KC_LCTL,KC_LGUI,KC_LALT,                _______,                        KC_RALT,KC_RGUI,_______,_______),
...
[_FL2] = KEYMAP_HHKB(
  ...
  KC_NLCK,KC_P7  ,KC_P8  ,KC_P9  ,KC_PAST,_______,_______,_______,_______,_______,_______,_______,_______,_______, \
